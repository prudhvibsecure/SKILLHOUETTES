...
public class Skill_Student extends AppCompatActivity  implements IItemHandler, View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        lauchActivity(StudentDetails.class, adapter.getItems(), itemPosition);
    }
