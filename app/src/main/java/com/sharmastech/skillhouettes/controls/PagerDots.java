...
import com.sharmastech.skillhouettes.callbacks.PageIndicator;
 ...
 */
public class PagerDots extends View implements PageIndicator {
    ...
    public PagerDots(Context context, AttributeSet attrs, int defStyle) {
