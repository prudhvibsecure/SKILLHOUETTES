...
public class StudentsAdapter extends RecyclerView.Adapter<StudentsAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int i) {
        ...
        try {
            ...
            contactViewHolder.tv_title.setText(Html.fromHtml(jsonObject.optString("firstname")+" "+jsonObject.optString("lastname")));
            ...
            imageLoader.DisplayImage(st_ad_img , contactViewHolder.iv_icon, 2);
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_students_frag, viewGroup,
                false);
