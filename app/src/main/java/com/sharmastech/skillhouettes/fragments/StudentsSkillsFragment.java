...
import com.sharmastech.skillhouettes.adapters.StudentsSkillsAdapter;
...
public class StudentsSkillsFragment extends ParentFragment implements IItemHandler {
    ...
    private StudentsSkillsAdapter adapter;

    private Skillhouettes activity;

    public StudentsSkillsFragment() {
        // Required empty public constructor
    }

    public static StudentsSkillsFragment newInstance() {
        return new StudentsSkillsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new StudentsSkillsAdapter(activity);
